...
class CookieSettingListener
{
    ...
    public function onKernelResponse(ResponseEvent $event)
    {
        ...
        if ((defined('\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST') ? HttpKernelInterface::MAIN_REQUEST : HttpKernelInterface::MASTER_REQUEST) !== $event->getRequestType() || !($event->getResponse()->isSuccessful() || $event->getResponse()->isRedirection())) {
            return;
        }
